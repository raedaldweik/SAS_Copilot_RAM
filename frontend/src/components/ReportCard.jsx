...
export default function ReportCard({ spec }) {
  ...
  return (
    <div className="rounded-xl overflow-hidden animate-slide-up"
      style={{ border: '1px solid rgba(185,28,44,0.18)', background: 'rgba(255,255,255,0.75)' }}>
      {/* Title bar */}
      <div className="flex items-center gap-2 px-3.5 py-2.5"
        style={{ background: 'rgba(185,28,44,0.06)', borderBottom: '1px solid rgba(185,28,44,0.12)' }}>
        ...
        {spec.sectionName && (
          <span className="text-[10px] px-1.5 py-0.5 rounded-full font-semibold shrink-0"
            style={{ background: 'rgba(185,28,44,0.10)', color: 'var(--gold-lo)' }}>
            {spec.sectionName}
          </span>
        )}
      ...
      {/* Footer */}
      {spec.viewerUrl && (
        <div className="px-3.5 py-2" style={{ borderTop: '1px solid rgba(185,28,44,0.10)' }}>
